### Medusa.js Product Customization – Integration Guide
...
Add a reusable client function to create a new line item with design metadata. This repository already includes an implementation:
