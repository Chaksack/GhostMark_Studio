...
export const DesignAreaGroup = model.define("design_area_group", {
  ...
  group_price: model.bigNumber().nullable(), // Price in minor units for the entire group
  ...
  // Group constraints
  max_designs_per_group: model.number().default(1), // How many designs can be placed per group
