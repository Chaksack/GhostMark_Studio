...
<template>
  <main class="bg-white text-ink-950">
    <!-- ============================================================
         1. Breadcrumb
         ============================================================ -->
    <section class="mx-auto max-w-[1320px] px-gutter pt-section">
      <nav
    ...
    <section
      v-if="meta"
      class="mx-auto max-w-[1320px] px-gutter py-section bg-cream-tile"
    ...
    <section
      v-else
      class="mx-auto max-w-[1320px] px-gutter py-section"
